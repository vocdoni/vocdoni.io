...
export function HeadTags(pageContext: PageContext) {
  ...
  // The brand logo, NOT the page's social image: a case study's cover art is not
  // Vocdoni's logo, and telling search engines otherwise changes the logo per page.
  ...
  const moduleSourceSchema = isDecidimModule
    ? {
        ...
        name: 'Decidim Secure Elections',
        alternateName: ['decidim-secure_elections', 'Secure elections component for Decidim'],
