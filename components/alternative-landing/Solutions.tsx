      ...
      <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
        ...
        <div className='flex gap-6 max-lg:flex-col'>
          ...
          <MotionPreset fade blur slide delay={0.1} transition={{ duration: 0.5 }} inView inViewOnce>
            <Card className='group flex-1 transition-all duration-500 bg-transparent border-transparent hover:flex-2 hover:border-primary hover:bg-primary/10'>
          ...
          <MotionPreset fade blur slide delay={0.2} transition={{ duration: 0.5 }} inView inViewOnce>
            <Card className='group flex-1 transition-all duration-500 bg-transparent border-transparent hover:flex-2 hover:border-black hover:bg-black/10 dark:hover:border-white dark:hover:bg-white/10'>
              <CardContent className='flex p-6'>
                <div className='space-y-6'>
                  <Avatar className='size-10 shadow-sm'>
          ...
          <MotionPreset fade blur slide delay={0.3} transition={{ duration: 0.5 }} inView inViewOnce>
            <Card className='group flex-1 transition-all duration-500 bg-transparent border-transparent hover:flex-2 hover:border-sky-600 hover:bg-sky-600/10 dark:hover:border-sky-400 dark:hover:bg-sky-400/10'>
              <CardContent className='flex p-6'>
                <div className='space-y-6'>
                  <Avatar className='size-10 shadow-sm'>
