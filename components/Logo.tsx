...
interface VocdoniLogoProps extends React.SVGProps<SVGSVGElement> {
  minimal?: boolean
  className?: string
}

export const VocdoniLogo = ({ minimal = false, className, ...props }: VocdoniLogoProps) => {
  // Use currentColor to inherit the text color from parent
