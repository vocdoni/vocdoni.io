      ...
      <div className='p-2 mx-auto text-center'>
        ...
        <h1 className='text-[clamp(1.8rem,6vw,4.2rem)] font-bold leading-tight mb-16'>
          <Trans i18nKey='explore.headline'>
            ...
            that empowers communities, associations, and institutions to make collective decisions with full
            transparency, privacy and trust. <span className='inline-block'>🤝</span>
          </Trans>
        </h1>
        ...
        <div className='mt-20'>
          <p className='text-sm font-medium text-gray-600 mb-8'>
            {t('explore.trusted_by', { defaultValue: 'Trusted by' })}
          </p>
